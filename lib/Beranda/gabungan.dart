...
import 'package:selfsafetyapp_test/Beranda/berita.dart';

class StaticValues {
  List<News> news = [
    News(
        title:
            "1.509 Bencana Alam Januari-Mei 2022 di RI: Banjir Paling Banyak",
        descrption:
            "Jakarta, CNN Indonesia -- Sebanyak 1.509 kejadian bencana alam terjadi di Indonesia, terhitung sejak 1 Januari hingga 14 Mei 2022. Dari data tersebut, banjir dan cuaca ekstrem mendominasi bencana yang terjadi. Menurut data dari Badan Nasional Penanggulangan Bencana (BNPB), selama 2022 terjadi bencana gempa bumi sebanyak 10 kali.",
        image:
            "https://akcdn.detik.net.id/visual/2022/05/11/banjir-di-tangerang-1_169.jpeg?w=650",
    ...
    News(
        ...
        image:
            "https://akcdn.detik.net.id/community/media/visual/2021/10/26/lestari-moerdijat_43.jpeg?w=700&q=90",
        source: "Detik News",
        sourceImage:
    ...
    News(
        ...
        image:
            "https://www.aljazeera.com/wp-content/uploads/2022/05/AP22150702613180.jpg?resize=770%2C513",
        source: "Aljazeera",
        sourceImage:
    ...
    News(
        title:
            "USDA offers disaster assistance to S.D. farmers impacted by the recent severe storms",
        image:
            "https://cdn.forumcomm.com/dims4/default/0dd3132/2147483647/strip/true/crop/1024x683+0+4/resize/840x560!/format/webp/quality/90/?url=https%3A%2F%2Ffcc-cue-exports-brightspot.s3.us-west-2.amazonaws.com%2Ffccnn%2Fbinary%2Fcopy%2F0c%2F83%2Fa7720eb3901d4c45e506a9dbb21f%2F4000004-crops-binary-807407.jpg",
